...
variables:
  random_variable1: "random variable" # will be available in markdown using: {{random_variable1}}
---

# Intro

with no plugins, the default behavior follows the [commonmark-spec](https://spec.commonmark.org/).

# CommonMark (also Heading lvl 1)
